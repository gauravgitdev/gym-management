...
<body>
    <nav class="navbar">
        ...
        <?php 
            if (isset($_SESSION['loggedin'])) {
              echo '  <li><a href="instrHome.php">Home</a></li>';
                echo '<li><a href="instrProfile.php">Profile</a></li>';
                echo '<li><a href="logout.php">Logout</a></li>';
            }  
            ?> 
            <li><a href="contact_instr.php">Contact Us</a></li>
        </ul>
    </nav>
    ...
    <section class="contact-section">
        <div class="contact-container">
            ...
            <form action="contact_instr.php" method="POST"id="contactForm">
